...
const PRODUCTS: readonly Product[] = [
  {
    ...
    imageUrl: 'https://www.nescafe.com/mu/sites/default/files/2023-10/PLP-CategoryHeaders-NescafeClassic-336x150.jpg',
    brandColor: '#C8102E',
    placeholderIcon: '',
  },
  {
    ...
    imageUrl: 'https://www.nescafe.com/mu/sites/default/files/2024-05/PLP-Category-Gold_336x150.jpg',
    brandColor: '#D4A853',
    placeholderIcon: '',
  },
  {
    ...
    imageUrl: 'https://www.nescafe.com/mu/sites/default/files/2023-10/NESCAFE-Ricoffy%20%281%29.png',
    brandColor: '#FFD700',
    placeholderIcon: '',
  },
  {
  ...
  {
    name: 'Nescafe Ricoffy Decaf',
    category: 'Coffee',
    format: 'Decaf chicory blend, 250g',
    imageUrl: '/products/ricoffy-decaf.png',
    brandColor: '#8B6914',
    placeholderIcon: '',
  },
] as const;
