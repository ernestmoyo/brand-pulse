...
const SEGMENT_OPTIONS = {
  ...
  sec: ['All', 'AB', 'C1', 'C2D'],
  district: ['All', 'Port Louis', 'Pamplemousses', 'Riviere du Rempart', 'Flacq', 'Grand Port', 'Savanne', 'Moka', 'Riviere Noire', 'Beau-Bassin/Rose-Hill', 'Quatre-Bornes', 'Vacoas/Phoenix', 'Curepipe'],
};
