...
const demoUsers = [
  { id: '1', name: 'Irfan Mooradun', email: 'admin@exotica.mu', role: 'ADMIN', org: 'Exotica Agency', lastLogin: '2026-03-31 14:30', active: true },
  { id: '2', name: 'Analyst', email: 'analyst@exotica.mu', role: 'ANALYST', org: 'Exotica Agency', lastLogin: '2026-03-30 09:15', active: true },
  { id: '3', name: 'Nestle Mauritius', email: 'nestle@client.mu', role: 'CLIENT_VIEWER', org: 'Nestle Mauritius', lastLogin: '2026-03-28 16:42', active: true },
];
